                    ...
                    <div class="shadow p-3">
                        <form action="{{route('post.store')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="post_title" class="form-control" value="{{old('post_title')}}" id="post_title">
                            ...
                            <div class="form-group">
                                ...
                                <textarea  name="description" class="form-control summernote" value="{{old('description')}}" id="description"> </textarea>
                            ...
                            <div class="form-group">
                                ...
                                <label for="noImage"> Post Image: </label>
